...
{
    FileSystemServer fs;
    std::string name_r1 = CConst::KPATH_DEBUG + CConst::SEP_CH_FILE + "abc.txt";
    std::string name_e1 = "abc.txt";
    std::string name_e2 = CConst::KPATH_DEBUG + CConst::SEP_CH_FILE + CConst::KPATH_DEBUG + CConst::SEP_CH_FILE + "abc.txt";
