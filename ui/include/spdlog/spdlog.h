...
// #define L_TRACE(logger, ...) logger->trace(__VA_ARGS__)  << " (" << __FILE__ << " #" << __LINE__ <<")";
// #else
...
#define L_TRACE(logger, ...) logger->trace(__VA_ARGS__)  << " (" << __FILE__ << " #" << __LINE__ <<")";
#define L_DEBUG(logger, ...) logger->debug(__VA_ARGS__)  << " (" << __FILE__ << " #" << __LINE__ <<")";
#define L_INFO(logger, ...) logger->info(__VA_ARGS__) << " (" << __FILE__ << " #" << __LINE__ <<")";
#define L_WARN(logger, ...) logger->warn(__VA_ARGS__) << " (" << __FILE__ << " #" << __LINE__ <<")";
#define L_ERROR(logger, ...) logger->error(__VA_ARGS__) << " (" << __FILE__ << " #" << __LINE__ <<")";
#else
#define L_TRACE(logger, ...) logger->trace(__VA_ARGS__);
#define L_DEBUG(logger, ...) logger->debug(__VA_ARGS__);
#define L_INFO(logger, ...) logger->info(__VA_ARGS__);
#define L_WARN(logger, ...) logger->warn(__VA_ARGS__);
#define L_ERROR(logger, ...) logger->error(__VA_ARGS__);
#endif
